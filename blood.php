                                        ...
                                        <form method="post" enctype="multipart/form-data">
                                            ...
                                            <table class="table table-bordered table-responsive">
                                                ...
                                                <tr>
                                                    ...
                                                    <th>
                                                        <span><input type="text" name="name"placeholder="IN BLOCK LETTERS" class="form-control" value=""></span>
                                                ...
                                                <tr>
                                                    ...
                                                    <th>
                                                        <span><input type="text" name="age" class="form-control" value=""></span>
                                                ...
                                                <tr>
                                                    ...
                                                    <th>
                                                        <span><input type="file" name="po1" class="form-control"value=""></span>
